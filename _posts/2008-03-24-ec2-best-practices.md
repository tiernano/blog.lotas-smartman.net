...
[update] The Space Program Blog also has this post about getting [MySQL running on EC2 in the /mnt storage partition][4]. Mind you, they mention that if anything goes wrong it goes away, but still handy! :)
