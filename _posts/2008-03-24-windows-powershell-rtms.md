...
categories:
  - Uncategorized
---
Well, what is the RTM count now? :) Windows PowerShell has now RTMed, and is available in a few different places. Firstly, [the announcement on the Windows PowerShell Blog][1]&nbsp;is where i got all the links, so Congrads to them and Thanks for the links! :) Next the links:
