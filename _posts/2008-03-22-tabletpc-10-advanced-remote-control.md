...
categories:
  - Uncategorized
---
[The Code Project &#8211; TabletPC 1.0 Advanced Remote Control &#8211; .NET Compact Framework][1]. now thats cool! I posted [this link][2] a few days ago on how to use a standard graphics tablet to turn your PC into a tablet PC. now, you can use your pocket pc to turn your pc into a tablet pc. i have to try this out when my axim arives! and the code is included too so you can modify it or see how its done! Dont forget to vote for it though! if anything i have seen on the site deserves a free PDA, that does! :)
