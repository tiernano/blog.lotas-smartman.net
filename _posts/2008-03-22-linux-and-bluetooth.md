...
Im going to try to move to linux soon. i want linux on my workstation and now that i got the new board that supports it, why the hell not!!! :P i have a copy of [VMware][4] so i can run windows apps when needed. i should have my chips by the time im learning VB in Fas so that should allow me to run VB under VMware a lot faster. dont be suprised if the next post is from my linux box :P
