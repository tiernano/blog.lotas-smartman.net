...
all my final files where then in the _site folder. I then use [RSync][13] to transfer the contents of my_site folder to the server and heay presto! its live! Well, semi live...
