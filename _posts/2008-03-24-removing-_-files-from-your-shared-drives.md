...
categories:
  - Uncategorized
---
if you have shares that your Apple machines regulary put files on (like me) you may have noticed the many ._files that are left on your system. [this hint over on MacOSX Hits][1] show you how to solve this problem, by removing the files using a window script.
