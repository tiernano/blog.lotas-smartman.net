      ...
      * Convert DVR-MS files to WMV without Commercials
        * Convert DVR-MS files to WMA (audio only)
          * Edit DVR-MS files and save directly back to DVR-MS
            * and much more!
                        Very cool stuff. I like the idea of ripping out the ads, converting to a different format, etc. I will be playing with this later tonight! :) Hopefully you can set the size of the WMV (for the PPC&#8230;)
