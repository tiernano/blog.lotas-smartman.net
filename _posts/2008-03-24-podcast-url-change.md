...
categories:
  - Uncategorized
---
If youare still subscribed to my Podcast, which hasent been updated in a while, but will be soon (hint, hint!) there is a new URL. the new URL is <a class=popup href="http://feeds.feedburner.com/TiernansPodcast" target=_blank>http://feeds.feedburner.com/TiernansPodcast</a>. The reason i am moving to this URL is because of ease of use, and stats. Thanks in advance, and Good luck! :)
